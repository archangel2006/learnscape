'use server';
/**
 * @fileOverview A Genkit flow for analyzing a camera frame to identify objects and materials.
 *
...
const AnalyzeSceneOutputSchema = z.object({
  object: z.string().describe('The name of the main identified object.'),
...
The user is focusing on this specific area to learn more about it.

Analyze the image and return a JSON object with:
- "object": The common name of the object.
